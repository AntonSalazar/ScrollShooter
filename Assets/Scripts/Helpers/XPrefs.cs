...
namespace xPrefsTools
{
	...
	public static class XPrefs
	{
		...
		{
			return PlayerPrefsWrapper.GetInt (key, value);
		...
		{
			return PlayerPrefsWrapper.GetFloat (key, value);
		...
		{
			Long_v lv;
			lv.m = GetFloat ("__m__" + key, value);
			lv.e = GetInt ("__e__" + key, (int)value);
			return LvToLong (lv);
		}
		...
		public static ulong GetULong (string key, ulong value = 0)
		{
			Long_v lv;
			lv.m = GetFloat ("__m__" + key, value);
			lv.e = GetInt ("__e__" + key, (int)value);
        ...
        /// <param name="key">Key.</param>
        public static bool GetBool (string key, int value = 0)
		{
			return (GetInt (key, value) != 0);
		}
